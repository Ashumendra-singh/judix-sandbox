    ...
    <div className='grid grid-cols-1 m-0  lg:grid-cols-2 xl:grid-cols-3 gap-12 mt-12 '>
        <div className='col-span-1'>
            ...
            <Card className='rounded-t-none p-9'>
                <div className='flex flex-col gap-4'>
                    <ul className='list-none list-inside flex flex-col gap-2 text-body-md '>
                        <li className='flex items-center' ><Check size={14} className="text-gray-900 mr-2"/> 500 case summaries</li>
                        <li className='flex items-center' ><Check size={14} className="text-gray-900 mr-2"/>30 Advanced searches per month</li>
                        <li className='flex items-center' ><Check size={14} className="text-gray-900 mr-2"/>100 MB storage for saved research</li>
                        <li className='flex items-center' ><Check size={14} className="text-gray-900 mr-2"/>1 project ( Research Folder )</li>
                        <li className='flex items-center' ><Check size={14} className="text-gray-900 mr-2"/>7-day research history</li>
            ...
            <Card className='rounded-t-none p-9 h-content'>
                <div className='flex flex-col gap-4'>
                    <ul className='list-none list-inside flex flex-col gap-2 text-body-md]'>
                        ...
                        <li className='flex items-center' ><Check size={14} className="text-gray-900 mr-2"/>1 project ( Research Folder )</li>
                        <li className='flex items-center' ><Check size={14} className="text-gray-900 mr-2"/>7-day research history</li>
                        <li className='flex items-center ' ><Check size={14} className="text-gray-900 mr-2"/>Import shared research</li>
                        <li className='flex items-center text-neutral-500' ><X size={14} className=" mr-2"/>Team collaboration</li>
                    </ul>
                </div>
            </Card> 
