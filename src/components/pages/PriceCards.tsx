...
function PriceCards() {
  return (
    <div className='grid grid-cols-1 md:grid-cols-3 gap-12 mt-12 '>
        ...
        <div className='border-[2px] border-primary-400 rounded-md'>
        ...
        <div className='col-span-1 md:col-span-2 '>
            <Card  title='ADD ON' className='p-9 font-satoshi min-h-[357px]'>
                <div className=''>
                    ...
                    <div className='flex flex-col gap-8 text-body-md le'>
                        <p >Instant legal research on the go. Perfect for when you’re away from your desk, in transit, or need quick clarity. Uses your existing usage quota.</p>
        ...
        <div className='sm:col-span-1' >
            <Card title='ENTERPRISE TEAMS' className='p-9 font-satoshi min-h-[357px]'>
